...
app.use((req, res, next) => {
  ...
  res.locals.footerSocials = FOOTER_SOCIALS;
...
app.get('/', (req, res) => {
  res.render('index', {
    title: 'Невидимый ассистент для разговоров',
    description:
      'Ghost AI — невидимый ассистент, который слушает системный звук, подсказывает формулировки в реальном времени и собирает аналитику встреч.',
